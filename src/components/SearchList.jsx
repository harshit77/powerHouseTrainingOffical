              ...
              <article className="listContainer">
                ...
                <section className="middleListSection">
                  <div className="subtext">
                    <div className="subtextHeader">Name </div>
                    <div className="subTextContent">
                      {customer.firstName} {customer.lastName}
                    </div>
                  </div>
                  <div className="subtext">
                    <div className="subtextHeader">Plan Start Date </div>
                    <div className="subTextContent">25/06/2019</div>
                  </div>
                  <div className="subtext">
                    <div className="subtextHeader">Plan End Date </div>
                    <div className="subTextContent">25/06/2019</div>
                  </div>
                  <div className="subtext">
                    <div className="subtextHeader">Phone Number </div>
                    <div className="subTextContent">{customer.phoneNumber}</div>
                  </div>
                  ...
                  <div
                    className={
                      customer.status === "ACTIVE"
                        ? "activeStatus mblayout"
                        : customer.status === "DANGER"
                        ? "dangerStatus mblayout"
                        : "deactiveStatus mblayout"
                    }
                  >
                    {customer.status === "DANGER"
                      ? "Payment Due"
